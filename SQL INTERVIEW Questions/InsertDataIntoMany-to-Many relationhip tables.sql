/*how to insert data into a table that has many-to-many relationship.
We will use the following 3 tables for this example
students(id,name) -> studentcourses(studentid, courseid) --> courses (id,name)
*/
...
As you can see, StudentCourses is a bridge table that has many to many relationship with Students and Courses tables. 
This means a given student can be enrolled into many courses and a given course can have many students enrolled.
